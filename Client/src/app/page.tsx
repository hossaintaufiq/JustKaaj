...
//               <span className="text-green-700 hover:underline cursor-pointer">Basundhara R/A</span>
//               <span className="text-green-700 hover:underline cursor-pointer">Uttora</span>
//               <span className="text-green-700 hover:underline cursor-pointer">Gulshan</span>
//               <span className="text-green-700 hover:underline cursor-pointer">Banani</span>
//               <span className="text-green-700 hover:underline cursor-pointer">Badda</span>
//               <span className="text-green-700 hover:underline cursor-pointer">Dhanmondi</span>
//               <span className="text-green-700 hover:underline cursor-pointer">Mirpur</span>
