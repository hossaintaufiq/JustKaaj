          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6 md:mb-8 max-w-lg">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-5 sm:px-6 py-3 sm:py-4 rounded-lg text-gray-900 text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-green-400"
              />
            </div>
            <button className="bg-green-400 hover:bg-green-500 text-white px-6 py-3 sm:py-4 rounded-lg transition-colors flex items-center justify-center gap-2 min-w-[120px] font-semibold">
