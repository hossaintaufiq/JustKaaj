  ...
  return (
    <footer id="contact" className="bg-gray-800 text-gray-300 py-10 sm:py-12">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8 max-w-6xl mx-auto">
          <div>
            <Logo variant="light" />
          ...
          <div>
            <h3 className="text-white font-semibold text-base sm:text-lg mb-3 sm:mb-4">Information</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h3 className="text-white font-semibold text-base sm:text-lg mb-3 sm:mb-4">Newsletter</h3>
            ...
            <div className="flex flex-col sm:flex-row">
              <input
                ...
                className="flex-1 px-3 sm:px-4 py-2 bg-gray-700 text-white rounded-t-lg sm:rounded-l-lg sm:rounded-t-none focus:outline-none focus:ring-2 focus:ring-green-400 text-sm sm:text-base"
              />
              <button className="bg-green-400 hover:bg-green-500 text-white px-4 sm:px-6 py-2 rounded-b-lg sm:rounded-r-lg sm:rounded-b-none transition-colors text-sm sm:text-base">
                Subscribe
              </button>
            </div>
          </div>
